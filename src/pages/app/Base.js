  ...
  return (
    <Router history={history}>
      <Switch>
        ...
        <Route exact path="/orders" component={AppBase} />
        <Route exact path="/companies" component={AppBase} />
        <Route exact path="/merchants" component={AppBase} />
        <Route exact path="/users" component={AppBase} />
