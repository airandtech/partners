            ...
            fetch(baseUrl() + 'api/merchants', {
                ...
                .then((res) => {
                    if (res.statusCode === 200 && res.data.status) {
                        NotificationManager.success("Merchants retrieved", 'Success', 5000);

                        const data = res.data.data;
                        //console.log(riders)
                        this.setState({ data, loadingMerchants: false })
                        const options = []
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                selector: 'deliveryFrequency',
                sortable: true,
            },
            {
                name: 'Avg. Monthly Delivery',
                selector: 'avgMonthlyDelivery',
                sortable: true,
            },
            {
                name: 'Date',
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="page-title-box">
                                            ...
                                            <h4 className="page-title">List of merchants</h4>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="card-box">
                                            <h4 className="header-title">Merchants</h4>
                                            ...
                                            <DataTable
                                                ...
                                                pagination={true}
                                                progressPending={this.state.loadingMerchants}
                                                columns={columns}
